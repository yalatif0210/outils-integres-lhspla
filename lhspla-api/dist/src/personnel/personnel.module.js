...
exports.PersonnelModule = PersonnelModule = __decorate([
    (0, common_1.Module)({ imports: [prisma_module_1.PrismaModule], controllers: [personnel_controller_1.PersonnelController], providers: [personnel_service_1.PersonnelService], exports: [personnel_service_1.PersonnelService] })
], PersonnelModule);
